...
export const metadata: Metadata = {
  ...
  keywords: ["QR code generator", "free QR code", "custom QR code", "WiFi QR", "WhatsApp QR", "UPI QR code", "WiFi ka QR code kaise banaye",
    "UPI payment QR code free online",
    "online qr maker no ads"],
  authors: [{ name: "QRGen" }],
  creator: "QRGen",
